...
html.H2('Manuscripts'),
                dcc.Markdown("""
This map illustrates the location in which manuscripts of *The Seven Sages of Rome* are inferred to have been produced 
per century, as well as their number. \n
The regions of origin of the manuscripts were deduced according to the language in which the manuscript was written. \n
"""
